...
export class ReveurRomantiqueBtn extends BaseButton {
  public constructor(client: CustomClient) {
    super(client, {
      id: "reveur_romantique",
      roles: ["926922603250204692"],
    });
  }
  ...
  public async execute(
    ...
    const roleId = "1154900624073306252"; // Remplacez par l'ID réel du rôle
